...
class GlobalInfo implements JsonSerializable
{
    ...
    {
        return ['appId' => $this->appId, 'version' => $this->version, 'dataExchangeId' => $this->dataExchangeId,
    ...
    {
        return new self($jsonData['appId'], $jsonData['version'], $jsonData['dataExchangeId'], $jsonData['requestTime'], $jsonData['requestCode'], $jsonData['responseCode'], $jsonData['userName'], $jsonData['deviceMAC'], $jsonData['taxpayerID'], $jsonData['longitude'], $jsonData['latitude'], $jsonData['extendField']);
    }
}